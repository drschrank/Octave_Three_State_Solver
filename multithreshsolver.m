function [xbest,llike,xboot]=multithreshsolver(tbl,x0,optionsolve,boots,optionbootsk,...
  numofworkers)
...
parfor ind=1:boots
  ...
  State1index=find(bootbl.result=='1');
  State2index=find(bootbl.result=='2');
  State3index=find(bootbl.result=='3');
