...
optionsolve=optimset('MaxFunEvals',1e5,'MaxIter',500,'TolFun',1,'TolX',1,...
  'Display','iter');
...
figure;
hold on;
State1Plot = plot(plotstimulus, State1Prob.best, '-b', ...
  plotstimulus, State1Prob.hi, 'b:', plotstimulus, State1Prob.lo, ':b');
State2Plot = plot(plotstimulus, State2Prob.best, '-b', ...
  plotstimulus, State2Prob.hi, 'b:', plotstimulus, State2Prob.lo, ':b');
State3Plot = plot(plotstimulus, State3Prob.best, '-b', ...
  plotstimulus, State3Prob.hi, 'b:', plotstimulus, State3Prob.lo, ':b');
